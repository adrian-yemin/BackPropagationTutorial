...
# inputS1 = [0.3, 0.5]
# outputS1 = [0.1]
outputS1 = [0.1, 0.2]  # Target output for the first sample
# Second sample
...
# inputS2 = [0.5, 0.9]
# outputS2 = [0.2]
outputS2 = [0.2, 0.3]  # Target output for the second sample
...
n1.Layers[2].NeuronArray[1].Weights[0] = 0.4
n1.Layers[2].NeuronArray[1].Weights[1] = 0.2
n1.Layers[2].NeuronArray[1].Bias = 0.0
